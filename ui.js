                            ...
                            <div style="background:var(--c-bg0);border:1px solid var(--c-border2);border-radius:14px;padding:16px 20px;display:flex;align-items:center;gap:14px;flex-shrink:0;width:300px;">
                                ...
                                <div style="flex:1;min-width:0;">
                                    ...
                                    <div style="display:flex;align-items:center;justify-content:space-between;">
                                        ...
                                        <div style="font-size:10px;padding:2px 10px;border-radius:20px;font-weight:700;background:var(--c-accent-glow);border:1px solid var(--c-border);color:var(--c-accent);font-family:'Fira Code',monospace;">v4.9</div>
                                    </div>
                                </div>
                            </div>
                        </div>
